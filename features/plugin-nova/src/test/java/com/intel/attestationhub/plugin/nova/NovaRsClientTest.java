...
public class NovaRsClientTest {
    ...
    private static final Set<String> HOST1_CIT_TAGS = Sets.newHashSet("CUSTOM_CIT_TRUSTED", "CUSTOM_CIT_AT_STATE_AZ",
            "CUSTOM_CIT_AT_CITY_AUSTIN", "CUSTOM_CIT_AT_COUNTRY_US", "CUSTOM_CIT_AT_STATE_TX",
            "CUSTOM_CIT_AT_CITY_HILLSBORO", "CUSTOM_CIT_AT_STATE_OR");

    private static final Set<String> HOST1_CIT_UPDATED_TAGS = Sets.newHashSet("CUSTOM_CIT_TRUSTED",
            "CUSTOM_CIT_AT_STATE_AZ", "CUSTOM_CIT_AT_CITY_SANTA_CLARA", "CUSTOM_CIT_AT_COUNTRY_US",
            "CUSTOM_CIT_AT_STATE_TX", "CUSTOM_CIT_AT_STATE_OR");

    private static final Set<String> HOST2_CIT_TAGS = Sets.newHashSet("CUSTOM_CIT_AT_STATE_TN",
            "CUSTOM_CIT_AT_CITY_HYDERABAD", "CUSTOM_CIT_AT_STATE_KA", "CUSTOM_CIT_AT_COUNTRY_IN", "CUSTOM_CIT_TRUSTED",
            "CUSTOM_CIT_AT_CITY_BANGALORE", "CUSTOM_CIT_AT_STATE_AP");
    ...
    public void testGenerateTraitsFromAssetTags_WithSpecialCharInTags_ExpectSuccess() throws AttestationHubException {
        ...
        HostDetails hostDetails = generateHostDetails(trustReportJson);
        Set<String> expectedSet = Sets.newHashSet("CUSTOM_CIT_AT_COUNTRY___US", "CUSTOM_CIT_AT_STATE__O_R",
                "CUSTOM_CIT_AT_STATE___TX", "CUSTOM_CIT_AT_STATE__A_Z", "CUSTOM_CIT_TRUSTED",
